...
<form method="GET" class="filter-bar">
    ...
    @if(request()->hasAny(['anak_id','tanggal']))
        ...
        @if(request('anak_id'))
        <a href="{{ route('recall.export-pdf') }}?anak_id={{ request('anak_id') }}" class="btn btn-outline btn-sm">📄 PDF</a>
        @endif
    @endif
</form>
...
<div class="card fade-up" style="margin-bottom:20px;">
    <div class="card-header">
        <div class="card-title">📊 Ringkasan Gizi Hari Ini</div>
...
<div class="card fade-up">
    <div class="card-header">
        <div class="card-title">🍽️ Daftar Asupan ({{ $recalls->total() }})</div>
    </div>
                ...
                <tr>
                    ...
                    <td>
                        <div style="display:flex;gap:6px;align-items:center;">
                            <a href="{{ route('anak.show', $r->anak) }}" class="btn btn-outline btn-sm" title="Detail Anak">👁 Detail</a>

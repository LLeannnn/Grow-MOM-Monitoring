...
<div class="anak-grid">
    ...
    <a href="{{ route('anak.show', $a) }}" class="anak-card fade-up">
        ...
        <div style="margin-top:10px;font-size:12px;color:var(--text-muted);">👩 {{ $a->ibu->nama_ibu }}</div>
        ...
        <div style="margin-top:12px;padding-top:12px;border-top:1px solid var(--border);display:flex;gap:12px;justify-content:center;font-size:12px;">
            <div>⚖️ {{ $a->pertumbuhan_terakhir->berat_badan }} kg</div>
            <div>📏 {{ $a->pertumbuhan_terakhir->tinggi_badan }} cm</div>
        </div>
